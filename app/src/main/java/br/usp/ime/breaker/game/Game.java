package br.usp.ime.breaker.game;
...
import br.usp.ime.breaker.R;
import br.usp.ime.breaker.effects.Explosion;
import br.usp.ime.breaker.forms.Ball;
import br.usp.ime.breaker.forms.Brick;
import br.usp.ime.breaker.forms.Brick.Type;
import br.usp.ime.breaker.forms.MobileBrick;
import br.usp.ime.breaker.forms.Paddle;
import br.usp.ime.breaker.game.Constants.Collision;
import br.usp.ime.breaker.game.Constants.Color;
import br.usp.ime.breaker.game.Constants.Config;
import br.usp.ime.breaker.game.Constants.Difficult;
import br.usp.ime.breaker.game.Constants.Hit;
import br.usp.ime.breaker.game.Constants.Lives;
import br.usp.ime.breaker.game.Constants.Score;
import br.usp.ime.breaker.game.Constants.ScoreMultiplier;
